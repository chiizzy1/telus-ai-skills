# Close Variants — Complete Examples Reference

Every example from the official Telus Close Variants Rating Guidelines (September 2025), source PDF `TELUS-TASKS/Close Variants/Telus - Close Variants.pdf`.
